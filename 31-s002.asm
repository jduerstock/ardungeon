...
byte_769B:	.BYTE 0			; DATA XREF: sub_84CF+26w
		...
		.BYTE	0
		.BYTE	0
byte_76D9:	.BYTE 0			; DATA XREF: sub_7EA5+8w sub_7EA5+1Ew	...
byte_76DA:	.BYTE 0			; DATA XREF: sub_7EA5+Ew sub_7EA5+25w	...
byte_76DB:	.BYTE 0			; DATA XREF: sub_7B59+A2w sub_7B59+C5w ...
byte_76DC:	.BYTE 0			; DATA XREF: sub_7B59+A7w sub_7B59+CAw ...
		.BYTE	0
		.BYTE	0
		.BYTE	0
...
; ---------------------------------------------------------------------------
unk_8081:	.BYTE $92 ; í		; DATA XREF: sub_8061+Fr
		.BYTE $9F ; ü
		.BYTE $B6 ; ∂
		.BYTE $DB ; -
		.BYTE $D7 ; ◊
		...
		.BYTE $3A ; :
		.BYTE $40 ; @
unk_808A:	.BYTE $80 ; Ä		; DATA XREF: sub_8061+Br
		.BYTE $80 ; Ä
		.BYTE $80 ; Ä
		.BYTE $80 ; Ä
		.BYTE $80 ; Ä
...
; ---------------------------------------------------------------------------
unk_8630:	.BYTE $3B ; ;		; DATA XREF: sub_85DE+4Dr
		.BYTE  $C
		.BYTE $3B ; ;
		.BYTE $63 ; c
		.BYTE $7F ; 
		.BYTE $97 ; ó
unk_8636:	.BYTE $86 ; Ü		; DATA XREF: sub_85DE:loc_8627r
		.BYTE $88 ; à
		.BYTE $86 ; Ü
		.BYTE $88 ; à
		.BYTE $88 ; à
...
loc_8993:				; CODE XREF: RAM:897Fj	RAM:8982j ...
		...
		RTS
; ---------------------------------------------------------------------------
unk_899F:	.BYTE $B4 ; ¥		; DATA XREF: RAM:899Ar
		.BYTE $DB ; -
		.BYTE $DE ; ﬁ
		.BYTE $EE ; Ó
		.BYTE $52 ; R
		...
		.BYTE $99 ; ô
		.BYTE $A6 ; ¶
unk_89AA:	.BYTE $89 ; â		; DATA XREF: RAM:8996r
		.BYTE $89 ; â
		.BYTE $89 ; â
		.BYTE $89 ; â
		.BYTE $8A ; ä
...
unk_98F5:	.BYTE $A0 ; †		; DATA XREF: sub_7EA5+5r RAM:8D45r
		...
		.BYTE $E7 ; Á
		.BYTE $EE ; Ó
unk_9901:	.BYTE $98 ; ò		; DATA XREF: sub_7EA5+Br RAM:8D4Br
		.BYTE $98 ; ò
		.BYTE $98 ; ò
		.BYTE $98 ; ò
		.BYTE $98 ; ò
...
loc_9EFC:				; DATA XREF: RAM:9FAEo
		...
		RTS
; ---------------------------------------------------------------------------
unk_9F02:	.BYTE $A9 ; ©		; DATA XREF: RAM:9FD8o
		.BYTE	0
		.BYTE $8D ; ç
		.BYTE $FE ; ˛
		.BYTE $18
...
unk_9F5E:	.BYTE	8		; DATA XREF: RAM:loc_9F8Er
		...
		.BYTE $26 ; &
		.BYTE $2C ; ,
unk_9F66:	.BYTE $9F ; ü		; DATA XREF: RAM:9F94r
		.BYTE $9F ; ü
		.BYTE $9F ; ü
		.BYTE $9F ; ü
		.BYTE $9F ; ü
...
unk_9F6E:	.BYTE $30 ; 0		; DATA XREF: RAM:9FA0r
		...
		.BYTE $54 ; T
		.BYTE $5A ; Z
unk_9F76:	.BYTE $9F ; ü		; DATA XREF: RAM:9FA6r
		.BYTE $9F ; ü
		.BYTE $9F ; ü
		.BYTE $9F ; ü
		.BYTE $9F ; ü
...
byte_AA01:	.BYTE $FF		; DATA XREF: sub_8560+7r
byte_AA02:	.BYTE $85		; DATA XREF: sub_8560+Cr
		.BYTE $A6 ; ¶
		.BYTE $85 ; Ö
		.BYTE $AF ; Ø
		.BYTE $AD ; ≠
...
byte_AA13:	.BYTE $63		; DATA XREF: RAM:7845r
byte_AA14:	.BYTE $85		; DATA XREF: RAM:7840r
