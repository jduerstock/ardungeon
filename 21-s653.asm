...
loc_768E:				; CODE XREF: RAM:76F7vj	RAM:7708vj
		LDA	#0
		STA	byte_77AD

loc_7693:				; CODE XREF: RAM:76A9vj	RAM:76FFvj
		dldi	off_1977, $76A0
		JMP	$1806
; ---------------------------------------------------------------------------
		LDA	$31
...
loc_824E:				; CODE XREF: RAM:825Cvj
		LDY	#$C

loc_8250:				; CODE XREF: RAM:8257vj
		STA	$BB4C,X
		DEX
		BMI	loc_825E
		DEY
...
loc_8284:				; CODE XREF: RAM:8288vj	RAM:828Evj
					; DATA XREF: ...
		STA	$FFFF,X
		INX
		BNE	loc_8284
...
loc_82C9:				; CODE XREF: RAM:82EFvj
		LDY	6
		LDA	(7),Y
		STA	4
		LDY	#7

loc_82D1:				; CODE XREF: RAM:82DCvj
		LSR	4
		BCC	loc_82DB
		LDA	(9),Y
		ORA	#$80 ; 'Ä'
...
loc_8314:				; CODE XREF: RAM:8331vj
		LDX	#0

loc_8316:				; CODE XREF: RAM:832Fvj
		LDY	6
		LDA	(7),Y
		LDY	#4

loc_831C:				; CODE XREF: RAM:8321vj
		STA	($F0,X)
		INC	$F0,X
		DEY
		BNE	loc_831C
...
byte_83B6:	.BYTE 0			; DATA XREF: RAM:loc_837C^w RAM:838C^r ...
		...
		.BYTE	$02,$1B,$03,$2A,$00,$8A,$0A,$80,$A0,$1B,$02,$A8,$00,$A8,$A0,$0A
		.BYTE	$1B,$03,$AA,$00,$A8,$02,$1B,$02,$2A,$8A,$8A,$00,$0A,$A2,$A8,$A8
		.BYTE	$1B,$02,$AA,$00,$1B,$02,$AA,$28,$00,$0A,$2A,$00,$2A,$2A,$02,$A8
		.BYTE	$1B,$02,$AA,$00,$1B,$7E,$55,$1B,$7E,$55,$1B,$41,$55,$1B,$3F,$00
		.BYTE	$1B,$FF,$1B,$04,$0A,$1B,$1E,$08,$1B,$23,$36,$1B,$23,$0D,$1B,$23
		.BYTE	$2F,$07,$C0,$00,$00,$60,$0D,$60,$00,$01,$AC,$0D,$60,$00,$01,$2C
		.BYTE	$05,$40,$00,$01,$E8,$1B,$1D,$00,$02,$80,$00,$00,$50,$03,$80,$00
; end of 'RAM'
