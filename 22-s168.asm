...
loc_771F:				; CODE XREF: sub_7714+2Cj
		LDX	$63
		LDA	$63A2,X
		BMI	loc_773E
		STA	$4B
...
loc_7B4E:				; CODE XREF: RAM:7B6Bj
		LDX	#0

loc_7B50:				; CODE XREF: RAM:7B69j
		LDY	6
		LDA	(7),Y
		LDY	#4

loc_7B56:				; CODE XREF: RAM:7B5Bj
		STA	($F0,X)
		INC	$F0,X
		DEY
		BNE	loc_7B56
