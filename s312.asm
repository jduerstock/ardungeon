...
unk_7C79:	.BYTE $FF		; DATA XREF: sub_7AE7-2AEr
		...
		.BYTE $3F ; ?
		.BYTE	0
unk_7C7E:	.BYTE $E0 ; а		; DATA XREF: sub_7AE7-283r
		.BYTE $B0 ; °
		.BYTE $78 ; x
		.BYTE $3F ; ?
		.BYTE $85 ; …
...
unk_7C8F:	.BYTE $85 ; …		; DATA XREF: sub_7A36+70w
		...
		.BYTE $AD ; ­
		.BYTE	0
unk_7C95:	.BYTE $90 ; ђ		; DATA XREF: sub_7A36:loc_7AA3r
...
aProtection2:	.BYTE "Protection+2 (*)",0
		...
		.BYTE	0
		.BYTE	0
unk_828A:	.BYTE $CD ; Н		; DATA XREF: sub_7A05+4r
					; sub_7A36:loc_7A93r
		.BYTE $C1 ; Б
		.BYTE $C7 ; З
		.BYTE $C9 ; Й
		...
		.BYTE $A1 ; Ў
		.BYTE $A0 ;  
unk_8293:	.BYTE $C3 ; Г		; DATA XREF: sub_7A05+1Er
					; sub_7A36:loc_7AAEr
		.BYTE $D5 ; Х
		.BYTE $D2 ; Т
		.BYTE $D3 ; У
