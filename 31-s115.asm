...
loc_7627:				; CODE XREF: RAM:7659vj	RAM:7664vj ...
		INC	$1937
		JSR	$184E
		LDA	#$FF
		STA	byte_1959
...
loc_76B4:				; CODE XREF: sub_769B+21vj
		LDA	(off_7),Y
		CMP	byte_78DE
		BCS	loc_76BE
		INY
...
loc_777A:				; CODE XREF: sub_773A+51vj
		LDA	byte_78E5
		JSR	sub_78A1
		BCC	loc_7785
		INC	byte_78E2
...
loc_77A4:				; CODE XREF: sub_773A+75vj
		JSR	sub_78D5
		BCC	loc_77B1
		INC	byte_78E3
		DEC	byte_78E4
...
loc_77D6:				; CODE XREF: sub_773A+E0vj
		LDA	byte_78E1
		JSR	$1887
		BEQ	loc_7817
		LDY	#0
...
loc_780A:				; CODE XREF: sub_773A+D8vj
		LDA	(off_7),Y
...
loc_78B0:				; CODE XREF: sub_78D5+3vj
		LDA	byte_78E1
		STA	$4B
		JSR	$1887
		BEQ	sub_78D5
...
unk_9557:	.BYTE $8E ; é		; DATA XREF: RAM:7680^r
		...
		.BYTE $8F ; è
		.BYTE $8F ; è
off_955F:	.WORD	0		; DATA XREF: RAM:9C35vo	RAM:9C5Cvw ...
