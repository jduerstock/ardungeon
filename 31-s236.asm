...
:	JMP	$773A
	...
	.BYTE	$16
	.BYTE	"!",$22,$0D,$FF
	.BYTE	$02,$47,$aa,$4e,$aa,$9b,$aa,$56,$aa,$9b,$aa ; |.!"...G.N...V...|
...
;	.BYTE	$10,$aa,$0e,$00,$aa,$60 ; |.....`...u.. c..|
	.BYTE   $10,$aa,$0e,$00,$aa,$60,$a9,$12,$a2,$75,$a0,$08,$20,$63,$18,$90 
	.BYTE	$0B
;	LDA	#$12
;	ldxy	$7508
;	JSR	$1863
...
:	JMP	$76F8
	...
	.BYTE	$04,$47,$aa,$4d,$aa,$54,$aa,$76,$aa,$b8,$aa,$34,$40,$01 ; |..G.M.T.v...4@.|
