...
byte_197B:	.BYTE 0			; DATA XREF: sub_2BFA:loc_3032r
					; sub_5857+2w
unk_197C:	.BYTE $80 ; 		; DATA XREF: sub_2CFB:loc_2D03w
		.BYTE $80 ; 
		.BYTE $80 ; 
		.BYTE $80 ; 
		.BYTE $80 ; 
		...
		.BYTE $80 ; 
		.BYTE $80 ; 
unk_1987:	.BYTE $80 ; 		; DATA XREF: sub_2CFB:loc_2D18w
		.BYTE $80 ; 
		.BYTE $80 ; 
		.BYTE $80 ; 
		.BYTE $80 ; 
...
unk_1C19:	.BYTE $46 ; F		; DATA XREF: RAM:1B35r
		.BYTE $68 ; h
		.BYTE $88 ; 
unk_1C1C:	.BYTE $B6 ; Ж		; DATA XREF: RAM:loc_23A3r
		.BYTE $76 ; v
		.BYTE $9E ; 
		.BYTE $34 ; 4
		.BYTE	0
...
unk_1FB7:	.BYTE	2		; DATA XREF: RAM:1E55r
		...
		.BYTE	9
		.BYTE	9
unk_1FBF:	.BYTE $E6 ; ц		; DATA XREF: sub_1C88+42r
		.BYTE $EC ; ь
		.BYTE $20
		.BYTE $FD ; §
		.BYTE $F2 ; ђ
...
unk_25E5:	.BYTE	0		; DATA XREF: sub_2503+42r
		...
		.BYTE	7
		.BYTE	6
unk_25EB:	.BYTE $A1 ; Ё		; DATA XREF: sub_256B+2Fr
		.BYTE	1
		.BYTE $A1 ; Ё
		.BYTE $A1 ; Ё
		.BYTE $A1 ; Ё
...
unk_2611:	.BYTE	4		; DATA XREF: sub_2503+36r
		...
		.BYTE	8
		.BYTE	8
unk_2617:	.BYTE $F1 ; ё		; DATA XREF: sub_2503+22r
		.BYTE $F4 ; є
		.BYTE $F8 ; ј
		.BYTE $FE ; ў
		.BYTE	3
...
unk_261D:	.BYTE $25 ; %		; DATA XREF: sub_2503+27r
		...
		.BYTE $26 ; &
		.BYTE $26 ; &
unk_2623:	.BYTE $C5 ; Х		; DATA XREF: sub_2503+18r
		.BYTE $C8 ; Ш
		.BYTE $CC ; Ь
		.BYTE $D2 ; в
		.BYTE $D7 ; з
...
loc_5400:				; CODE XREF: RAM:53F8j
		...
		RTS
; ---------------------------------------------------------------------------
unk_5409:	.BYTE $EC ; ь		; DATA XREF: RAM:5404r
		.BYTE $C4 ; -
...
unk_5A9C:	.BYTE $5A ; Z		; DATA XREF: sub_5AB4+116r
		...
		.BYTE $5A ; Z
		.BYTE $5A ; Z
unk_5AA8:	.BYTE $BB ; Л		; DATA XREF: sub_5AB4+73r sub_5AB4+F0r
		.BYTE $BC ; М
		.BYTE $BD ; Н
		.BYTE $C1 ; С
		.BYTE $C0 ; Р
